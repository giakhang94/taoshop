    ...
    return (
        <div className="flex items-center justify-evenly  px-20 py-5">
            <div className="home-content flex flex-col w-[50%] pr-20">
                ...
                <p className="text-justify text-slate-600 text-lg tracking-[2px] mb-6">
            ...
            <div className="homehero-imgs w-[50%] h-full ml-[20%] relative shadow-lg shadow-gray-500 rounded-lg ">
                <img
