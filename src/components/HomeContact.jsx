    ...
    return (
        <div className="home-contact flex laptop:flex-row tablet:flex-col mobile:flex-col smallmobile:flex-col justify-around py-10 items-center">
            <div className="content  laptop:w-2/4 tablet:full mobile:w-full smallmobile:w-full tablet:px-5 mobile:px-3 smallmobile:px-3">
                <h2 className="text-2xl mobile:text-center smallmobile:tex-center tablet:text-center font-semibold tracking-[2px] text-[#102A42] laptop:mb-5 tablet:mb-3 mobile:mb-2 smallmobile:mb-2">
                    Join our newsletter and get 20% off
                </h2>
                <p className="leading-8 laptop:pr-[20%] text-justify text-[#102A42] mobile:text-center smallmobile:tex-center tablet:text-center">
